...
GenericFunctionStepDefinition<TWorld> testerGiven<TWorld extends FlutterWidgetTesterWorld>(
  Pattern pattern,
...
GenericFunctionStepDefinition<TWorld>
    testerGiven1<TInput1, TWorld extends FlutterWidgetTesterWorld>(
  Pattern pattern,
  Future<void> Function(
    TInput1 input1,
    StepContext<TWorld> context,
...
GenericFunctionStepDefinition<TWorld>
    testerGiven2<TInput1, TInput2, TWorld extends FlutterWidgetTesterWorld>(
  Pattern pattern,
  Future<void> Function(
    TInput1 input1,
    TInput2 input2,
...
GenericFunctionStepDefinition<TWorld>
    testerGiven3<TInput1, TInput2, TInput3, TWorld extends FlutterWidgetTesterWorld>(
  Pattern pattern,
  Future<void> Function(
    TInput1 input1,
    TInput2 input2,
...
GenericFunctionStepDefinition<TWorld>
    testerGiven4<TInput1, TInput2, TInput3, TInput4, TWorld extends FlutterWidgetTesterWorld>(
  Pattern pattern,
  Future<void> Function(
    TInput1 input1,
    TInput2 input2,
...
GenericFunctionStepDefinition<TWorld> testerGiven5<TInput1, TInput2, TInput3, TInput4, TInput5,
