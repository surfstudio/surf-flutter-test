...
class PlaceResidenceScreen extends ElementaryWidget<IPlaceResidenceScreenWidgetModel> {
...
class _MapOpenButton extends StatelessWidget {
  ...
  final Function({required WidgetBuilder builder, required ShapeBorder shape}) showBottomSheet;
