...
/// Loading error state.
class ErrorProfileLoadingState extends BaseProfileState implements ILoadAvailable {}

/// Profile state.
class ProfileState extends ProfileContentState implements ILoadAvailable, IEditingAvailable {
  /// Create an instance [ProfileState].
...
class ProfileSavedSuccessfullyState extends ProfileContentState {
  ...
  ProfileSavedSuccessfullyState({required Profile profile}) : super(profile: profile);
}
