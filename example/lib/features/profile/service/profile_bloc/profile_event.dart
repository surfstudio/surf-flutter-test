...
class UpdatePlaceResidenceEvent extends ProfileUpdateEvent {
  ...
  const UpdatePlaceResidenceEvent({String? placeResidence}) : super(placeResidence: placeResidence);
}
...
class UpdateInterestsEvent extends ProfileUpdateEvent {
  ...
  const UpdateInterestsEvent({List<String>? interests}) : super(interests: interests);
}
